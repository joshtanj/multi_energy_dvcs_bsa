...
public class rgk_7546MeV_dvcs_analysis_bsa_sub_pi0_sim_var_tbin {
	...
	static void processEvent(DataEvent event, int eventCounter)
	{
		if(event.hasBank("REC::Particle") && event.hasBank("REC::Track"))
		{
			...
			tbin_l.add(new double[] {0.18, 0.24, 0.34, 0.55}, 0);
			tbin_l.add(new double[] {0.23, 0.32, 0.43, 0.67}, 1);
			tbin_l.add(new double[] {0.21, 0.27, 0.36, 0.56}, 2);
			tbin_l.add(new double[] {0.37, 0.51, 0.65, 0.86}, 3);
			tbin_l.add(new double[] {0.32, 0.46, 0.61, 0.87}, 4);
			tbin_l.add(new double[] {0.28, 0.38, 0.51, 0.75}, 5);
			tbin_l.add(new double[] {0.45, 0.66, 0.83, 1.06}, 6);
			tbin_l.add(new double[] {0.53, 0.77, 1.06, 1.47}, 7);
	...
	static void processEvent_pi0(DataEvent event, int eventCounter)
	{
		if(event.hasBank("REC::Particle") && event.hasBank("REC::Track"))
		{
			...
			if(ecount == 1 && protoncount == 1 && gammacount == 2
					...
					&& 57.3*p_proton.theta() < 75)
			{
				if(((det_gamma1 == 10 && det_gamma2 == 10
						&& p_pi0.vect().theta(X_pi0.vect()) < 5.6
						&& Math.sqrt((X.px()*X.px())+(X.py()*X.py())) < 0.31
						&& X.e() < 1.1 && X_proton.mass() > 0.2 && X_proton.mass() < 1.7)
						||(((det_gamma1 == 10 && det_gamma2 == 7) || (det_gamma1 == 7 && det_gamma2 == 10))
						&& p_pi0.vect().theta(X_pi0.vect()) < 6.1
						&& Math.sqrt((X.px()*X.px())+(X.py()*X.py())) < 0.41
						&& X.e() < 1.7 && X_proton.mass() > 0.0 && X_proton.mass() < 1.9)
						|| (det_gamma1 == 7 && det_gamma2 == 7 && p_pi0.vect().theta(X_pi0.vect()) < 6.5
						&& Math.sqrt((X.px()*X.px())+(X.py()*X.py())) < 0.50
						&& X.e() < 2.3 && X_proton.mass() > 0.0 && X_proton.mass() < 2.1)) && Q2 > 1 && W > 2)
				{
					if(p_pi0.mass() > 0.0908 && p_pi0.mass() < 0.170)
					{
	...
	static void processEvent_pi0_sim(DataEvent event, int eventCounter)
	{
		if(event.hasBank("REC::Particle") && event.hasBank("REC::Track"))
		{
					...
					&& 57.3*p_proton.theta() < 75)
			{
				if(((det_gamma1 == 10
						&& p_gamma1.vect().theta(X_gamma1.vect()) < 3
						&& Math.sqrt((X_1gamma.px()*X_1gamma.px())+(X_1gamma.py()*X_1gamma.py())) < 0.25
						&& X_1gamma.e() < 0.75
						&& X_proton_1gamma.mass() > 0.5 && X_proton_1gamma.mass() < 1.6)
						|| (det_gamma1 == 7
						&& p_gamma1.vect().theta(X_gamma1.vect()) < 3.5
						&& Math.sqrt((X_1gamma.px()*X_1gamma.px())+(X_1gamma.py()*X_1gamma.py())) < 0.4
						&& X_1gamma.e() < 1.5
						&& X_proton_1gamma.mass() > 0.2 && X_proton_1gamma.mass() < 1.9))
						&& Q2 > 1 && W > 2
					...
					&& 57.3*p_proton.theta() < 75)
			{
				if(((det_gamma1 == 10 && det_gamma2 == 10
						&& p_pi0.vect().theta(X_pi0.vect()) < 5.6
						&& Math.sqrt((X_2gamma.px()*X_2gamma.px())+(X_2gamma.py()*X_2gamma.py())) < 0.31
						&& X_2gamma.e() < 1.1 && X_proton_2gamma.mass() > 0.2 && X_proton_2gamma.mass() < 1.7)
						||(((det_gamma1 == 10 && det_gamma2 == 7) || (det_gamma1 == 7 && det_gamma2 == 10))
						&& p_pi0.vect().theta(X_pi0.vect()) < 6.1
						&& Math.sqrt((X_2gamma.px()*X_2gamma.px())+(X_2gamma.py()*X_2gamma.py())) < 0.41
						&& X_2gamma.e() < 1.7 && X_proton_2gamma.mass() > 0.0 && X_proton_2gamma.mass() < 1.9)
						|| (det_gamma1 == 7 && det_gamma2 == 7 && p_pi0.vect().theta(X_pi0.vect()) < 6.5
						&& Math.sqrt((X_2gamma.px()*X_2gamma.px())+(X_2gamma.py()*X_2gamma.py())) < 0.50
						&& X_2gamma.e() < 2.3 && X_proton_2gamma.mass() > 0.0 && X_proton_2gamma.mass() < 2.1)) && Q2 > 1 && W > 2)
				{
					if(p_pi0.mass() > 0.0908 && p_pi0.mass() < 0.170)
					{
						if(p_gamma1.vect().theta(p_gamma2.vect()) > 2.5)
	...
	//	reader_pi0.open("C:/Users/joshtanj/Documents/download/skim_epgg_bank_merged_7546MeV_skim18.hipo");
	//	reader_pi0_sim.open("C:/Users/joshtanj/Documents/download/skim_epgg_epg_bank_rgk_fall2018_FTOff_noM_OUT.hipo");
		...
		*/		
		...
		tba.add(new double[] {0.15, 0.21, 0.28, 0.43, 0.78}, 0);
		tba.add(new double[] {0.18, 0.28, 0.37, 0.54, 0.93}, 1);
		tba.add(new double[] {0.17, 0.24, 0.31, 0.44, 0.84}, 2);
		tba.add(new double[] {0.25, 0.44, 0.58, 0.75, 1.09}, 3);
		tba.add(new double[] {0.23, 0.39, 0.53, 0.73, 1.18}, 4);
		tba.add(new double[] {0.21, 0.33, 0.44, 0.61, 1.10}, 5);
		tba.add(new double[] {0.31, 0.56, 0.74, 0.94, 1.34}, 6);
		tba.add(new double[] {0.37, 0.65, 0.91, 1.24, 1.91}, 7);
		...
		canbsa.getPad(0).setAxisRange(0, 360, -0.3, 0.3);
		...
		canbsa.getPad(1).setAxisRange(0, 360, -0.3, 0.3);
		...
		canbsa.getPad(2).setAxisRange(0, 360, 0, 1);
		...
		canbsa.getPad(3).setAxisRange(0, 360, -0.3, 0.3);
		...
		fBSA_sub_pi0_sim.setOptStat(110);
		...
		*/
		...
		for(int kbin = 0; kbin  < 8; kbin++)
		{
			for(int ktbin = 0; ktbin < 5; ktbin++)
			{
				...
				canbsa_tbin.getPad(0).setAxisRange(0, 360, -0.3, 0.3);
				...
				canbsa_tbin.getPad(1).setAxisRange(0, 360, -0.3, 0.3);
				...
				canbsa_tbin.getPad(2).setAxisRange(0, 360, 0, 1);
				...
				canbsa_tbin.getPad(3).setAxisRange(0, 360, -0.3, 0.3);
