...
public class rgk_6535MeV_dvcs_analysis_bsa_sub_moments_pi0_sim_var_tbin {
	...
	public static void main(String[] args) {
		...
		int eventCounter = 1;
		while(reader.hasEvent())// && eventCounter < 100000)
		{
		...
		while(reader_pi0.hasEvent())// && eventCounter_pi0 < 100000)
		{
		...
		while(reader_pi0_sim.hasEvent())// && eventCounter_pi0_sim < 1000000)
		{
		...
		for(int i = 0; i < 20; i++)
		{
			...
			R_pi0.add((phi_rb_poshel_pi0.get(i)+phi_rb_neghel_pi0.get(i))/(phi_rb_poshel.get(i)+phi_rb_neghel.get(i)));
		...
		for(int kbin = 0; kbin  < 8; kbin++)
		{
			...
			for(int ktbin = 0; ktbin < 5; ktbin++)
			{
				...
				for(int kent = 0; kent < 20; kent++)
				{
					...
					if(f_pi0_sim_tbin.hasItem(kbin, ktbin, kent) && Math.abs(ferr_pi0_sim_tbin.getItem(kbin, ktbin, kent)) < 0.2)
					{
		...
		GraphErrors hx_axis = new GraphErrors();
		hx_axis.addPoint(180, 0, 180, 0);
		...
		hx_axis.setMarkerSize(0);
		hx_axis.setMarkerStyle(0);
		hx_axis.setLineThickness(1);
		canbsa.draw(hx_axis, "same");
		...
		F1D ff_pi0_sim= new F1D("ff_pi0_sim", "[F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])", 0, 360);
		ff_pi0_sim.setParameter(0, 0.3);
		ff_pi0_sim.setParameter(1, 0.5);
		ff_pi0_sim.setParameter(2, 90);
		ff_pi0_sim.setParameter(3, 30);
		DataFitter.fit(ff_pi0_sim, hf_pi0_sim, "Q");
		ff_pi0_sim.setLineColor(2);
		ff_pi0_sim.setLineWidth(3);
		ff_pi0_sim.setOptStat(111110);
		canbsa.draw(ff_pi0_sim, "same");
		canbsa.cd(3);
		canbsa.setFont("Arial");
		hx_axis.setTitle("#pi^0_sim Corrected Beam Spin Asymmetry");
		hx_axis.setTitleX("#phi [#degree]");
		hx_axis.setTitleX("#pi^0_sim Corrected BSA");
		hx_axis.setMarkerSize(0);
		hx_axis.setMarkerStyle(0);
		hx_axis.setLineThickness(1);
		canbsa.draw(hx_axis, "same");
		...
		F1D fBSA_sub_pi0_sim= new F1D("fBSA_sub_pi0_sim", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
										+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
										+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))", 0, 360);
		fBSA_sub_pi0_sim.setParameter(0, ff_pi0_sim.getParameter(0));
		fBSA_sub_pi0_sim.setParameter(1, ff_pi0_sim.getParameter(1));
		fBSA_sub_pi0_sim.setParameter(2, ff_pi0_sim.getParameter(2));
		fBSA_sub_pi0_sim.setParameter(3, ff_pi0_sim.getParameter(3));
		fBSA_sub_pi0_sim.setParameter(4, fBSA.getParameter(0));
		fBSA_sub_pi0_sim.setParameter(5, fBSA.getParameter(1));
		fBSA_sub_pi0_sim.setParameter(6, fBSA_pi0.getParameter(0));
		fBSA_sub_pi0_sim.setLineColor(2);
		fBSA_sub_pi0_sim.setLineWidth(3);
		fBSA_sub_pi0_sim.setOptStat(11111110);
		canbsa.draw(fBSA_sub_pi0_sim, "same");
		F1D fBSA_sub_pi0_sim_plerr = new F1D("fBSA_sub_pi0_sim_plerr", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
												+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))"
												+ "+sqrt((([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))-[A_pi0]*sin(x/57.3))"
												+ "/((1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))"
												+ "*(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))))"
												+ "*(([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))-[A_pi0]*sin(x/57.3))"
												+ "/((1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))"
												+ "*(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))))"
												+ "*([dF]*[dF]+(gaus(x,[mean],[sigma])+gaus(x,360-[mean],[sigma]))"
												+ "*(gaus(x,[mean],[sigma])+gaus(x,360-[mean],[sigma]))*[damp]*[damp]"
												+ "+[amp]*[amp]*(gaus(x,[mean],[sigma])*(x-[mean])/([sigma]*[sigma])"
												+ "-gaus(x,360-[mean],[sigma])*(x-360+[mean])/([sigma]*[sigma]))"
												+ "*(gaus(x,[mean],[sigma])*(x-[mean])/([sigma]*[sigma])"
												+ "-gaus(x,360-[mean],[sigma])*(x-360+[mean])/([sigma]*[sigma]))*[dmean]*[dmean]"
												+ "+[amp]*[amp]*(gaus(x,[mean],[sigma])*(x-[mean])*(x-[mean])/([sigma]*[sigma]*[sigma])"
												+ "+gaus(x,360-[mean],[sigma])*(x-360+[mean])*(x-360+[mean])/([sigma]*[sigma]*[sigma]))"
												+ "*(gaus(x,[mean],[sigma])*(x-[mean])*(x-[mean])/([sigma]*[sigma]*[sigma])"
												+ "+gaus(x,360-[mean],[sigma])*(x-360+[mean])*(x-360+[mean])/([sigma]*[sigma]*[sigma]))*[dsigma]*[dsigma])"
												+ "+(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*([dA]*[dA]*sin(x/57.3)*sin(x/57.3)/((1+[B]*cos(x/57.3))*(1+[B]*cos(x/57.3)))"
												+ "+[dB]*[dB]*[A]*[A]*cos(x/57.3)*cos(x/57.3)*sin(x/57.3)*sin(x/57.3)"
												+ "/((1+[B]*cos(x/57.3))*(1+[B]*cos(x/57.3))*(1+[B]*cos(x/57.3))*(1+[B]*cos(x/57.3))))"
												+ "+(([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))"
												+ "/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*(([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))"
												+ "/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*[dA_pi0]*[dA_pi0]*sin(x/57.3)*sin(x/57.3))", 0, 360);
		fBSA_sub_pi0_sim_plerr.setParameter(0, ff_pi0_sim.getParameter(0));
		fBSA_sub_pi0_sim_plerr.setParameter(1, ff_pi0_sim.getParameter(1));
		fBSA_sub_pi0_sim_plerr.setParameter(2, ff_pi0_sim.getParameter(2));
		fBSA_sub_pi0_sim_plerr.setParameter(3, ff_pi0_sim.getParameter(3));
		fBSA_sub_pi0_sim_plerr.setParameter(4, fBSA.getParameter(0));
		fBSA_sub_pi0_sim_plerr.setParameter(5, fBSA.getParameter(1));
		fBSA_sub_pi0_sim_plerr.setParameter(6, fBSA_pi0.getParameter(0));
		fBSA_sub_pi0_sim_plerr.setParameter(7, ff_pi0_sim.parameter(0).error());
		fBSA_sub_pi0_sim_plerr.setParameter(8, ff_pi0_sim.parameter(1).error());
		fBSA_sub_pi0_sim_plerr.setParameter(9, ff_pi0_sim.parameter(2).error());
		fBSA_sub_pi0_sim_plerr.setParameter(10, ff_pi0_sim.parameter(3).error());
		fBSA_sub_pi0_sim_plerr.setParameter(11, fBSA.parameter(0).error());
		fBSA_sub_pi0_sim_plerr.setParameter(12, fBSA.parameter(1).error());
		fBSA_sub_pi0_sim_plerr.setParameter(13, fBSA_pi0.parameter(0).error());
		fBSA_sub_pi0_sim_plerr.setLineStyle(3);
		fBSA_sub_pi0_sim_plerr.setLineColor(2);
		fBSA_sub_pi0_sim_plerr.setLineWidth(1);
		canbsa.draw(fBSA_sub_pi0_sim_plerr, "same");
		F1D fBSA_sub_pi0_sim_mnerr = new F1D("fBSA_sub_pi0_sim_mnerr", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
												+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))"
												+ "-sqrt((([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))-[A_pi0]*sin(x/57.3))"
												+ "/((1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))"
												...
												+ "/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*[dA_pi0]*[dA_pi0]*sin(x/57.3)*sin(x/57.3))", 0, 360);
		fBSA_sub_pi0_sim_mnerr.setParameter(0, ff_pi0_sim.getParameter(0));
		fBSA_sub_pi0_sim_mnerr.setParameter(1, ff_pi0_sim.getParameter(1));
		fBSA_sub_pi0_sim_mnerr.setParameter(2, ff_pi0_sim.getParameter(2));
		fBSA_sub_pi0_sim_mnerr.setParameter(3, ff_pi0_sim.getParameter(3));
		fBSA_sub_pi0_sim_mnerr.setParameter(4, fBSA.getParameter(0));
		fBSA_sub_pi0_sim_mnerr.setParameter(5, fBSA.getParameter(1));
		fBSA_sub_pi0_sim_mnerr.setParameter(6, fBSA_pi0.getParameter(0));
		fBSA_sub_pi0_sim_mnerr.setParameter(7, ff_pi0_sim.parameter(0).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(8, ff_pi0_sim.parameter(1).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(9, ff_pi0_sim.parameter(2).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(10, ff_pi0_sim.parameter(3).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(11, fBSA.parameter(0).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(12, fBSA.parameter(1).error());
		fBSA_sub_pi0_sim_mnerr.setParameter(13, fBSA_pi0.parameter(0).error());
		fBSA_sub_pi0_sim_mnerr.setLineStyle(3);
		fBSA_sub_pi0_sim_mnerr.setLineColor(2);
		fBSA_sub_pi0_sim_mnerr.setLineWidth(1);
		canbsa.draw(fBSA_sub_pi0_sim_mnerr, "same");
		/*
		System.out.println("==========================================================================================");
		...
		System.out.println("==========================================================================================");
		System.out.println("#pi^0_sim Corrected BSA:	x	#deltax	y	#delta	y");
		for(int p = 0; p < 20; p++)		
		{
		System.out.println("	" + phibc[p] + "	" + 0 + "	" + bsa_sub_pi0_sim.get(p) + "	" + bsaerr_sub_pi0_sim.get(p));
		}
		...
		*/
		...
		for(int kbin = 0; kbin  < 8; kbin++)
		{
			for(int ktbin = 0; ktbin < 5; ktbin++)
			{
				...
				F1D ftf_pi0_sim= new F1D("ftf_pi0_sim", "[F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])", 0, 360);
				ftf_pi0_sim.setParameter(0, 0.3);
				ftf_pi0_sim.setParLimits(0, 0, 1);
				ftf_pi0_sim.setParameter(1, 0.5);
				ftf_pi0_sim.setParLimits(1, 0, 1);
				ftf_pi0_sim.setParameter(2, 90);
				ftf_pi0_sim.setParLimits(2, 0, 180);
				ftf_pi0_sim.setParameter(3, 30);
				ftf_pi0_sim.setParLimits(3, 20, 90);
				DataFitter.fit(ftf_pi0_sim, hf_pi0_sim_tbin.getItem(kbin, ktbin), "Q");
				ftf_pi0_sim.setLineColor(2);
				ftf_pi0_sim.setLineWidth(3);
				ftf_pi0_sim.setOptStat(111110);
				canbsa_tbin.draw(ftf_pi0_sim, "same");
				canbsa_tbin.cd(3);
				canbsa_tbin.setFont("Arial");
				...
				hx_axis.setLineThickness(1);
				canbsa_tbin.draw(hx_axis, "same");
				F1D ftBSA_sub_pi0_sim= new F1D("ftBSA_sub_pi0_sim", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
												+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
												+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))", 0, 360);
				ftBSA_sub_pi0_sim.setParameter(0, ftf_pi0_sim.getParameter(0));
				ftBSA_sub_pi0_sim.setParameter(1, ftf_pi0_sim.getParameter(1));
				ftBSA_sub_pi0_sim.setParameter(2, ftf_pi0_sim.getParameter(2));
				ftBSA_sub_pi0_sim.setParameter(3, ftf_pi0_sim.getParameter(3));
				ftBSA_sub_pi0_sim.setParameter(4, ftBSA.getParameter(0));
				ftBSA_sub_pi0_sim.setParameter(5, ftBSA.getParameter(1));
				ftBSA_sub_pi0_sim.setParameter(6, ftBSA_pi0.getParameter(0));
				ftBSA_sub_pi0_sim.setLineColor(2);
				ftBSA_sub_pi0_sim.setLineWidth(3);
				ftBSA_sub_pi0_sim.setOptStat(11111110);
				canbsa_tbin.draw(ftBSA_sub_pi0_sim, "same");
				F1D ftBSA_sub_pi0_sim_plerr = new F1D("ftBSA_sub_pi0_sim_plerr", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
														+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
														+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))"
														+ "+sqrt((([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))-[A_pi0]*sin(x/57.3))"
														+ "/((1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))"
														...
														+ "/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
														+ "*[dA_pi0]*[dA_pi0]*sin(x/57.3)*sin(x/57.3))", 0, 360);
				ftBSA_sub_pi0_sim_plerr.setParameter(0, ftf_pi0_sim.getParameter(0));
				ftBSA_sub_pi0_sim_plerr.setParameter(1, ftf_pi0_sim.getParameter(1));
				ftBSA_sub_pi0_sim_plerr.setParameter(2, ftf_pi0_sim.getParameter(2));
				ftBSA_sub_pi0_sim_plerr.setParameter(3, ftf_pi0_sim.getParameter(3));
				ftBSA_sub_pi0_sim_plerr.setParameter(4, ftBSA.getParameter(0));
				ftBSA_sub_pi0_sim_plerr.setParameter(5, ftBSA.getParameter(1));
				ftBSA_sub_pi0_sim_plerr.setParameter(6, ftBSA_pi0.getParameter(0));
				ftBSA_sub_pi0_sim_plerr.setParameter(7, ftf_pi0_sim.parameter(0).error());
				if (ftf_pi0_sim.getParameter(0) < 0.001) ftBSA_sub_pi0_sim_plerr.setParameter(7, 0);
				ftBSA_sub_pi0_sim_plerr.setParameter(8, ftf_pi0_sim.parameter(1).error());
				ftBSA_sub_pi0_sim_plerr.setParameter(9, ftf_pi0_sim.parameter(2).error());
				ftBSA_sub_pi0_sim_plerr.setParameter(10, ftf_pi0_sim.parameter(3).error());
				ftBSA_sub_pi0_sim_plerr.setParameter(11, ftBSA.parameter(0).error());
				ftBSA_sub_pi0_sim_plerr.setParameter(12, ftBSA.parameter(1).error());
				ftBSA_sub_pi0_sim_plerr.setParameter(13, ftBSA_pi0.parameter(0).error());
				ftBSA_sub_pi0_sim_plerr.setLineStyle(3);
				ftBSA_sub_pi0_sim_plerr.setLineColor(2);
				ftBSA_sub_pi0_sim_plerr.setLineWidth(1);
				canbsa_tbin.draw(ftBSA_sub_pi0_sim_plerr, "same");
				F1D ftBSA_sub_pi0_sim_mnerr = new F1D("ftBSA_sub_pi0_sim_mnerr", "(1/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
														+ "*([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))"
														+ "-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))*[A_pi0]*sin(x/57.3))"
														+ "-sqrt((([A]*sin(x/57.3)/(1+[B]*cos(x/57.3))-[A_pi0]*sin(x/57.3))"
														+ "/((1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma])))"
														...
														+ "/(1-([F]+[amp]*gaus(x,[mean],[sigma])+[amp]*gaus(x,360-[mean],[sigma]))))"
														+ "*[dA_pi0]*[dA_pi0]*sin(x/57.3)*sin(x/57.3))", 0, 360);
				ftBSA_sub_pi0_sim_mnerr.setParameter(0, ftf_pi0_sim.getParameter(0));
				ftBSA_sub_pi0_sim_mnerr.setParameter(1, ftf_pi0_sim.getParameter(1));
				ftBSA_sub_pi0_sim_mnerr.setParameter(2, ftf_pi0_sim.getParameter(2));
				ftBSA_sub_pi0_sim_mnerr.setParameter(3, ftf_pi0_sim.getParameter(3));
				ftBSA_sub_pi0_sim_mnerr.setParameter(4, ftBSA.getParameter(0));
				ftBSA_sub_pi0_sim_mnerr.setParameter(5, ftBSA.getParameter(1));
				ftBSA_sub_pi0_sim_mnerr.setParameter(6, ftBSA_pi0.getParameter(0));
				ftBSA_sub_pi0_sim_mnerr.setParameter(7, ftf_pi0_sim.parameter(0).error());
				if (ftf_pi0_sim.getParameter(0) < 0.001) ftBSA_sub_pi0_sim_mnerr.setParameter(7, 0);
				ftBSA_sub_pi0_sim_mnerr.setParameter(8, ftf_pi0_sim.parameter(1).error());
				ftBSA_sub_pi0_sim_mnerr.setParameter(9, ftf_pi0_sim.parameter(2).error());
				ftBSA_sub_pi0_sim_mnerr.setParameter(10, ftf_pi0_sim.parameter(3).error());
				ftBSA_sub_pi0_sim_mnerr.setParameter(11, ftBSA.parameter(0).error());
				ftBSA_sub_pi0_sim_mnerr.setParameter(12, ftBSA.parameter(1).error());
				ftBSA_sub_pi0_sim_mnerr.setParameter(13, ftBSA_pi0.parameter(0).error());
				ftBSA_sub_pi0_sim_mnerr.setLineStyle(3);
				ftBSA_sub_pi0_sim_mnerr.setLineColor(2);
				ftBSA_sub_pi0_sim_mnerr.setLineWidth(1);
				canbsa_tbin.draw(ftBSA_sub_pi0_sim_mnerr, "same");
				
				System.out.println("======================================================================");
				System.out.println("Q^2-x_B Bin: " + kbin + ", -t Bin: " + ktbin);
				System.out.println("ftf_pi0_sim.parameter(0).error(): " + ftf_pi0_sim.parameter(0).error());
				System.out.println("ftf_pi0_sim.parameter(1).error(): " + ftf_pi0_sim.parameter(1).error());
				System.out.println("ftf_pi0_sim.parameter(2).error(): " + ftf_pi0_sim.parameter(2).error());
				System.out.println("ftf_pi0_sim.parameter(3).error(): " + ftf_pi0_sim.parameter(3).error());
				System.out.println("ftBSA.parameter(0).error(): " + ftBSA.parameter(0).error());
				System.out.println("ftBSA.parameter(1).error(): " + ftBSA.parameter(1).error());
				System.out.println("ftBSA_pi0.parameter(0).error(): " + ftBSA_pi0.parameter(0).error());
				System.out.println("A: " + ftBSA_sub_pi0_sim.evaluate(90) + " +/- " + ftBSA_sub_pi0_sim_plerr.evaluate(90));
			//	System.out.println("B: " + ftBSA_sub_pi0_sim.parameter(1).value() + " +/- " + ftBSA_sub_pi0_sim.parameter(1).error());
				...
				halpha_corr_pi0_sim_vs_t.getItem(kbin).addPoint(tba.getItem(kbin)[ktbin], ftBSA_sub_pi0_sim.evaluate(90),
																	0, Math.abs(ftBSA_sub_pi0_sim_plerr.evaluate(90)-ftBSA_sub_pi0_sim.evaluate(90)));
			}
		}
