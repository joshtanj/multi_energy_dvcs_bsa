...
public class p_e_elastic_correction_fix_fit {
...
static void processEventsampler(DataEvent event, int corEventCounter, byte setsector, IndexedList<Double> thetaCorFac) {
	...
	public static void main(String[] args) {
		...
		byte setsector = 1;
			...
			reader.open("C:/Users/joshtanj/Documents/download/merged_skim_ep_bank_6535MeV_skim_elastic_59xx.hipo");
			...
			double[] thetamean = new double[]{7.62, 9.12, 10.79, 12.80, 14.83, 16.82, 19.47, 22.28, 26.24, 60};
			...
			for(int seci = 0; seci < 6; seci++)
			{
				...
				phiCorFac.add(1.0, seci, 9, 0);
				phiCorFac.add(0.0, seci, 9, 1);
				phiCorFac.add(0.0000000001, seci, 9, 2);
				phiCorFac.add(0.0000000001, seci, 9, 3);
			}
			...
			for(int seci = 0; seci < 6; seci++)
			{
				for(int phcfi = 0; phcfi < 2; phcfi++)
				{
					...
					System.out.println("======================================================================");
					System.out.println("Sector: " + (seci+1) + "	Coefficient: a" + phcfi);
					System.out.println("#theta [#degree]	|	" + "a" + phcfi + "	|	" + "#deltaa" + phcfi);
					
					for(int thetabfi = 0; thetabfi < 10; thetabfi++)
					{
						{
			...
			/*
			readersampler.open("C:/Users/joshtanj/Documents/download/merged_skim_ep_bank_6535MeV_skim_elastic_59xx.hipo");
			...
			for(int canhg1i = 0; canhg1i < 6; canhg1i++){
				...
				canhg1sampler.getPad(canhg1i).setTitleFontSize(20);
				canhg1sampler.getPad(canhg1i).setAxisTitleFontSize(20);
				canhg1sampler.getPad(canhg1i).setAxisLabelFontSize(20);
				canhg1sampler.getPad(canhg1i).setStatBoxFontSize(20);
			...
			canhs1sampler.getPad(0).setTitleFontSize(20);
			canhs1sampler.getPad(0).setAxisTitleFontSize(20);
			canhs1sampler.getPad(0).setAxisLabelFontSize(20);
			canhs1sampler.getPad(0).setStatBoxFontSize(20);
			...
			for(int canhg1cori = 0; canhg1cori < 6; canhg1cori++){
				...
				canhg1corsampler.getPad(canhg1cori).setTitleFontSize(20);
				canhg1corsampler.getPad(canhg1cori).setAxisTitleFontSize(20);
				canhg1corsampler.getPad(canhg1cori).setAxisLabelFontSize(20);
				canhg1corsampler.getPad(canhg1cori).setStatBoxFontSize(20);
			...
			canhs1csampler.getPad(0).setTitleFontSize(20);
			canhs1csampler.getPad(0).setAxisTitleFontSize(20);
			canhs1csampler.getPad(0).setAxisLabelFontSize(20);
			canhs1csampler.getPad(0).setStatBoxFontSize(20);
