...
public class rgk_7546MeV_p_e_correction_exe {
	...
	static H1F htheta_cone_gamma = new H1F("theta_cone_gamma", "theta_cone_gamma", 100, 0, 5);
	static H1F hX_eg_m = new H1F("X_eg_m", "X_eg_m", 100, 0, 2);
	static H1F hX_epg_pt = new H1F("X_epg_pt", "X_epg_pt", 100, 0, 0.5);
	static H1F hX_epg_E = new H1F("X_epg_E", "X_epg_E", 100, -1, 1);
	static H1F hpcor_theta_cone_gamma = new H1F("pcortheta_cone_gamma", "pcortheta_cone_gamma", 100, 0, 5);
	static H1F hpcor_X_eg_m = new H1F("pcorX_eg_m", "pcorX_eg_m", 100, 0, 2);
	static H1F hpcor_X_epg_pt = new H1F("pcorX_epg_pt", "pcorX_epg_pt", 100, 0, 0.5);
	static H1F hpcor_X_epg_E = new H1F("pcorX_epg_E", "pcorX_epg_E", 100, -1, 1);
	...
	public static void histos_dvcs_ev_sec() {
		for(int seci = 0; seci < 6; seci++) {
			H1F htheta_cone_gamma_sec = new H1F("htheta_cone_gamma_sec", "htheta_cone_gamma_sec", 100, 0, 5 );
			histGroups_theta_cone_gamma_sec.add(htheta_cone_gamma_sec, seci);
			H1F hp_cor_theta_cone_gamma_sec = new H1F("hp_cor_theta_cone_gamma_sec", "hp_cor_theta_cone_gamma_sec", 100, 0, 5 );
			...
			H1F hX_epg_pt_sec = new H1F("hX_epg_pt_sec", "hX_epg_pt_sec", 100, 0, 0.5);
			histGroups_X_epg_pt_sec.add(hX_epg_pt_sec, seci);
			H1F hp_cor_X_epg_pt_sec = new H1F("hp_cor_X_epg_pt_sec", "hp_cor_X_epg_pt_sec", 100, 0, 0.5);
			histGroups_p_cor_X_epg_pt_sec.add(hp_cor_X_epg_pt_sec, seci);
			H1F hX_epg_E_sec = new H1F("hX_epg_E_sec", "hX_epg_E_sec", 100, -1, 1);
			histGroups_X_epg_E_sec.add(hX_epg_E_sec, seci);
			H1F hp_cor_X_epg_E_sec = new H1F("hp_cor_X_epg_E_sec", "hp_cor_X_epg_E_sec", 100, -1, 1);
	...
	public static void histos_dvcs_ev_vs_phi_bin() {
		for(int seci = 0; seci < 6; seci++) {
			for(int thetabin = 0; thetabin < 9; thetabin++) {
				for(int phibin = 0; phibin < 4; phibin++) {
					H1F htheta_cone_gamma_vs_phi_bin = new H1F("htheta_cone_gamma_vs_phi_bin", "htheta_cone_gamma_vs_phi_bin", 100, 0, 5 );
					...
					H1F hp_cor_theta_cone_gamma_theta_phi_bin = new H1F("hp_cor_theta_cone_gamma_theta_phi_bin",
																			"hp_cor_theta_cone_gamma_theta_phi_bin", 100, 0, 5 );
					...
					H1F hX_epg_pt_vs_phi_bin = new H1F("hX_epg_pt_vs_phi_bin", "hX_epg_pt_vs_phi_bin", 100, 0, 0.5);
					histGroups_X_epg_pt_theta_phi_bin.add(hX_epg_pt_vs_phi_bin, seci, thetabin, phibin);
					H1F hp_cor_X_epg_pt_theta_phi_bin = new H1F("hp_cor_X_epg_pt_theta_phi_bin", "hp_cor_X_epg_pt_theta_phi_bin", 100, 0, 0.5);
					histGroups_p_cor_X_epg_pt_theta_phi_bin.add(hp_cor_X_epg_pt_theta_phi_bin, seci, thetabin, phibin);
					H1F hX_epg_vs_phi_bin = new H1F("hX_epg_vs_phi_bin", "hX_epg_vs_phi_bin", 100, -1, 1);
					histGroups_X_epg_E_theta_phi_bin.add(hX_epg_vs_phi_bin, seci, thetabin, phibin);
					H1F hp_cor_X_epg_E_theta_phi_bin = new H1F("hp_cor_X_epg_E_theta_phi_bin", "hp_cor_X_epg_E_theta_phi_bin", 100, -1, 1);
			...
			if(pid == 22)
			{
				...
				if(event.hasBank("REC::ForwardTagger"))
				{
					...
					for(int m = 0; m < recft.rows(); m++)
					{
						...
						// Start: FTCAL Corrections
						if(fid_ftcal_gamma = true)
						{
							float p_corr = (float) (p-0.03689+0.1412*p-0.04316*p*p+0.007046*p*p*p-0.0004055*p*p*p*p);
							p_gamma = new LorentzVector(px*p_corr/p, py*p_corr/p, pz*p_corr/p, p_corr);
						}
					}
				}
	...
	public static void main(String[] args) {
		...
		double[] thetaCorFac_sec1_b0 = new double[] {1.0033983373271473, -0.001893902453660415, 2.6977250208365714E-4,
														-1.1911622599977624E-5, 1.5210433700960115E-7};
		double[] thetaCorFac_sec1_b1 = new double[] {0.002650933647394496, -7.29605164515548E-4, 7.912570415394922E-5,
														-3.4652682033049823E-6, 5.3360442836546055E-8};
		double[] thetaCorFac_sec2_b0 = new double[] {1.009105882923634, -0.004780922102038343, 6.925776306862123E-4,
														-3.70460671046235E-5, 6.53028700117475E-7};
		double[] thetaCorFac_sec2_b1 = new double[] {4.755972791387052E-4, -5.8487828272802135E-5, 5.803133148073901E-6,
														-2.2875875033620234E-7, 2.428203612285335E-9};
		double[] thetaCorFac_sec3_b0 = new double[] {1.0138899935156738, -0.005768251821887716, 7.955003587087042E-4,
														-4.011815299439149E-5, 6.624574336444477E-7};
		double[] thetaCorFac_sec3_b1 = new double[] {-6.85169059402634E-4, 2.3197722910220947E-4, -2.8891782314548918E-5,
														1.3501230314088673E-6, -2.133409051478935E-8};
		double[] thetaCorFac_sec4_b0 = new double[] {1.0023779597994589, -0.002042705313035238, 3.624334557173902E-4,
														-1.9699326692999563E-5, 3.289109863825498E-7};
		double[] thetaCorFac_sec4_b1 = new double[] {1.601658805605346E-4, -5.83609942803288E-5, 5.19048480428825E-6,
														-2.1395379867150074E-7, 3.518680502273446E-9};
		double[] thetaCorFac_sec5_b0 = new double[] {0.9642075791679217, 0.0070366179004003465, -4.002718634264232E-4,
														6.937075802290607E-6, -6.04981397744922E-9};
		double[] thetaCorFac_sec5_b1 = new double[] {-9.54415923867953E-4, 2.9645877205903057E-4, -2.9496495367683884E-5,
														1.2177513944047732E-6, -1.8577226478899843E-8};
		double[] thetaCorFac_sec6_b0 = new double[] {0.9575344969272623, 0.011491291017399109, -9.401730475853857E-4,
														3.3007977407366154E-5, -4.4208817617953134E-7};
		double[] thetaCorFac_sec6_b1 = new double[] {0.002115026702423413, -6.202612572014147E-4, 6.218795472785941E-5,
														-2.5645079029970745E-6, 3.7765468579955106E-8};
	...
	// Elastic	
		...
		readerelastic.open("C:/Users/joshtanj/Documents/download/merged_skim_ep_bank_7546MeV_skim_elastic.hipo");
	...
	// pi+n	
		...
		readerpiplusn.open("C:/Users/joshtanj/Documents/download/merged_skim_epi+_bank_7546MeV_skim_custom.hipo");
	...
	// DVCS	
		...
		readerdvcs.open("C:/Users/joshtanj/Documents/download/skim_6bank_epg_merged_7546MeV_skim16.hipo");
		...
		ftc = new F1D("ftc", "[A]*exp(-(x-[x0])/[w])", htheta_cone_gamma.getMaximumBin()*0.05, 5);
		ftc.setParameter(0, htheta_cone_gamma.getMax());
		ftc.setParLimits(0, htheta_cone_gamma.getMax()+1, htheta_cone_gamma.getMax()-1);
		ftc.setParameter(1, (htheta_cone_gamma.getMaximumBin()*0.05));
		ftc.setParLimits(1, ((htheta_cone_gamma.getMaximumBin()-1)*0.05), ((htheta_cone_gamma.getMaximumBin()+1)*0.05));
		ftc.setParameter(2, htheta_cone_gamma.getRMS()/2);
		ftc.setParLimits(2, htheta_cone_gamma.getRMS()/4, 5);
		...
		fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])", (hX_eg_m.getMaximumBin()*0.02-0.25), (hX_eg_m.getMaximumBin()*0.02+0.15));
		...
		fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])", hX_epg_pt.getMaximumBin()*0.005, 0.5);
		fXpt.setParameter(0, hX_epg_pt.getMax());
		fXpt.setParLimits(0, hX_epg_pt.getMax()+1, hX_epg_pt.getMax()-1);
		fXpt.setParameter(1, (hX_epg_pt.getMaximumBin()*0.005));
		fXpt.setParLimits(1, ((hX_epg_pt.getMaximumBin()-1)*0.005), ((hX_epg_pt.getMaximumBin()+1)*0.005));
		fXpt.setParameter(2, hX_epg_pt.getRMS()/2);
		fXpt.setParLimits(2, hX_epg_pt.getRMS()/4, 0.5);
		...
		fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])", (hX_epg_E.getMaximumBin()*0.02-1.3),
						(hX_epg_E.getMaximumBin()*0.02-0.8));
		fXe.setParameter(0, hX_epg_E.getMax());
		fXe.setParameter(1, (hX_epg_E.getMaximumBin()*0.02-1));
		...
		ftc.setParameter(1, (hpcor_theta_cone_gamma.getMaximumBin()*0.05));
		ftc.setParLimits(1, ((hpcor_theta_cone_gamma.getMaximumBin()-1)*0.05), ((hpcor_theta_cone_gamma.getMaximumBin()+1)*0.05));
		ftc.setParameter(2, hpcor_theta_cone_gamma.getRMS()/2);
		ftc.setParLimits(2, hpcor_theta_cone_gamma.getRMS()/4, 5);
		...
		fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])", (hpcor_X_eg_m.getMaximumBin()*0.02-0.25), (hpcor_X_eg_m.getMaximumBin()*0.02+0.15));
		...
		fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])", hpcor_X_epg_pt.getMaximumBin()*0.005, 0.5);
		fXpt.setParameter(0, hpcor_X_epg_pt.getMax());
		fXpt.setParLimits(0, hpcor_X_epg_pt.getMax()+1, hpcor_X_epg_pt.getMax()-1);
		fXpt.setParameter(1, (hpcor_X_epg_pt.getMaximumBin()*0.005));
		fXpt.setParLimits(1, ((hpcor_X_epg_pt.getMaximumBin()-1)*0.005), ((hpcor_X_epg_pt.getMaximumBin()+1)*0.005));
		fXpt.setParameter(2, hpcor_X_epg_pt.getRMS()/2);
		fXpt.setParLimits(2, hpcor_X_epg_pt.getRMS()/4, 0.5);
		...
		fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])", (hpcor_X_epg_E.getMaximumBin()*0.02-1.3),
						(hpcor_X_epg_E.getMaximumBin()*0.02-0.8));
		fXe.setParameter(0, hpcor_X_epg_E.getMax());
		fXe.setParameter(1, (hpcor_X_epg_E.getMaximumBin()*0.02-1));
		...
		for(int seci = 0; seci < 6; seci++){
			...
			ftc.setParameter(1, (histGroups_theta_cone_gamma_sec.getItem(seci).getMaximumBin()*0.05));
			ftc.setParLimits(1, ((histGroups_theta_cone_gamma_sec.getItem(seci).getMaximumBin()-1)*0.05),
									((histGroups_theta_cone_gamma_sec.getItem(seci).getMaximumBin()+1)*0.05));
			ftc.setParameter(2, histGroups_theta_cone_gamma_sec.getItem(seci).getRMS()/2);
			ftc.setParLimits(2, histGroups_theta_cone_gamma_sec.getItem(seci).getRMS()/4, 5);
		...
		for(int seci = 0; seci < 6; seci++){
			...
			ftc.setParameter(1, (histGroups_p_cor_theta_cone_gamma_sec.getItem(seci).getMaximumBin()*0.05));
			ftc.setParLimits(1, ((histGroups_p_cor_theta_cone_gamma_sec.getItem(seci).getMaximumBin()-1)*0.05),
									((histGroups_p_cor_theta_cone_gamma_sec.getItem(seci).getMaximumBin()+1)*0.05));
			ftc.setParameter(2, histGroups_p_cor_theta_cone_gamma_sec.getItem(seci).getRMS()/2);
			ftc.setParLimits(2, histGroups_p_cor_theta_cone_gamma_sec.getItem(seci).getRMS()/4, 5);
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])", (histGroups_X_eg_m_sec.getItem(seci).getMaximumBin()*0.02-0.25),
							(histGroups_X_eg_m_sec.getItem(seci).getMaximumBin()*0.02+0.15));
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])", (histGroups_p_cor_X_eg_m_sec.getItem(seci).getMaximumBin()*0.02-0.25),
							(histGroups_p_cor_X_eg_m_sec.getItem(seci).getMaximumBin()*0.02+0.15));
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])",  histGroups_X_epg_pt_sec.getItem(seci).getMaximumBin()*0.005, 0.5);
			...
			fXpt.setParameter(1, ( histGroups_X_epg_pt_sec.getItem(seci).getMaximumBin()*0.005));
			fXpt.setParLimits(1, (( histGroups_X_epg_pt_sec.getItem(seci).getMaximumBin()-1)*0.005), (( histGroups_X_epg_pt_sec.getItem(seci).getMaximumBin()+1)*0.005));
			fXpt.setParameter(2,  histGroups_X_epg_pt_sec.getItem(seci).getRMS()/2);
			fXpt.setParLimits(2,  histGroups_X_epg_pt_sec.getItem(seci).getRMS()/4, 0.5);
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])",  histGroups_p_cor_X_epg_pt_sec.getItem(seci).getMaximumBin()*0.005, 0.5);
			...
			fXpt.setParameter(1, ( histGroups_p_cor_X_epg_pt_sec.getItem(seci).getMaximumBin()*0.005));
			fXpt.setParLimits(1, (( histGroups_p_cor_X_epg_pt_sec.getItem(seci).getMaximumBin()-1)*0.005),
								(( histGroups_p_cor_X_epg_pt_sec.getItem(seci).getMaximumBin()+1)*0.005));
			fXpt.setParameter(2,  histGroups_p_cor_X_epg_pt_sec.getItem(seci).getRMS()/2);
			fXpt.setParLimits(2,  histGroups_p_cor_X_epg_pt_sec.getItem(seci).getRMS()/4, 0.5);
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])", (histGroups_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-1.3),
							(histGroups_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-0.8));
			fXe.setParameter(0, histGroups_X_epg_E_sec.getItem(seci).getMax());
			fXe.setParameter(1, (histGroups_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-1));
		...
		for(int seci = 0; seci < 6; seci++){
			...
			fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])", (histGroups_p_cor_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-1.3),
							(histGroups_p_cor_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-0.8));
			fXe.setParameter(0, histGroups_p_cor_X_epg_E_sec.getItem(seci).getMax());
			fXe.setParameter(1, (histGroups_p_cor_X_epg_E_sec.getItem(seci).getMaximumBin()*0.02-1));
			...
			for(int theta_bini = 0; theta_bini < 9; theta_bini++)
			{
				for(int phi_bini = 0; phi_bini < 4; phi_bini++)
				{
					ftc = new F1D("ftc", "[A]*exp(-(x-[x0])/[w])",
									histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.05, 5);
					...
					ftc.setParameter(1, (histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.05));
					ftc.setParLimits(1, ((histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()-1)*0.05),
										((histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()+1)*0.05));
					ftc.setParameter(2, histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/2);
					ftc.setParLimits(2, histGroups_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/4, 5);
					...
					ftc = new F1D("ftc", "[A]*exp(-(x-[x0])/[w])",
									histGroups_p_cor_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.05, 5);
					...
					ftc.setParameter(1, (histGroups_p_cor_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.05));
					...
					ftc.setParLimits(2, histGroups_p_cor_theta_cone_gamma_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/4, 5);
					...
					fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])",
									(histGroups_X_eg_m_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-0.25),
									(histGroups_X_eg_m_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02+0.15));
					...
					fpm = new F1D("fpm", "[amp]*gaus(x,[mean],[sigma])",
									(histGroups_p_cor_X_eg_m_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-0.25),
									(histGroups_p_cor_X_eg_m_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02+0.15));
					...
					fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])",
									histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.005, 0.5);
					...
					fXpt.setParameter(1, (histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.005));
					fXpt.setParLimits(1, ((histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()-1)*0.005),
										((histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()+1)*0.005));
					fXpt.setParameter(2, histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/2);
					fXpt.setParLimits(2, histGroups_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/4, 0.5);
					...
					fXpt = new F1D("fXpt", "[A]*exp(-(x-[x0])/[w])",
									histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.005, 0.5);
					...
					fXpt.setParameter(1, (histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.005));
					fXpt.setParLimits(1, ((histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()-1)*0.005),
										((histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()+1)*0.005));
					fXpt.setParameter(2, histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/2);
					fXpt.setParLimits(2, histGroups_p_cor_X_epg_pt_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getRMS()/4, 0.5);
					...
					fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])",
									(histGroups_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-1.3),
									(histGroups_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-0.8));
					fXe.setParameter(0, histGroups_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMax());
					fXe.setParameter(1, (histGroups_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-1));
					...
					fXe = new F1D("fXe", "[amp]*gaus(x,[mean],[sigma])",
									(histGroups_p_cor_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-1.3),
									(histGroups_p_cor_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-0.8));
					fXe.setParameter(0, histGroups_p_cor_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMax());
					fXe.setParameter(1, (histGroups_p_cor_X_epg_E_theta_phi_bin.getItem(seci, theta_bini, phi_bini).getMaximumBin()*0.02-1));
		...
		for(int theta_bini = 0; theta_bini < 9; theta_bini++){
			...
			for(int seci = 0; seci < 6; seci++){
				...
				canthetaconegammaphibin.getPad(seci).setAxisRange((phi_rot[seci]-30), (phi_rot[seci]+30), 0, 5);
		...
		for(int theta_bini = 0; theta_bini < 9; theta_bini++){
			...
			for(int seci = 0; seci < 6; seci++){
				...
				canXegmphibin.getPad(seci).setAxisRange((phi_rot[seci]-30), (phi_rot[seci]+30), 0.5, 1.5);
		...
		for(int theta_bini = 0; theta_bini < 9; theta_bini++){
			...
			for(int seci = 0; seci < 6; seci++){
				...
				canXepgptphibin.getPad(seci).setAxisRange((phi_rot[seci]-30), (phi_rot[seci]+30), 0, 0.5);
		...
		for(int theta_bini = 0; theta_bini < 9; theta_bini++){
			...
			for(int seci = 0; seci < 6; seci++){
				...
				canXepgEphibin.getPad(seci).setAxisRange((phi_rot[seci]-30), (phi_rot[seci]+30), -0.5, 0.5);
